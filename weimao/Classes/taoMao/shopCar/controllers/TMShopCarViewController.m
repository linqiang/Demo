...
-(UIView*)initNavigationBar
{
    ...
    //amount_icon@2x
//    UIImageView *amountImage=[[UIImageView alloc]initWithFrame:CGRectMake(title_label.frame.size.width+title_label.frame.origin.x, (title_label.frame.size.height-23)/2+2, 31, 23)];
//    amountImage.image=BundleImage(@"amount_icon.png");
//    [view_bar addSubview:amountImage];
//    
//    amoutLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, -1, 29, 20)];
//    amoutLabel.text=[NSString stringWithFormat:@"%d",[_marrayAll count]];
//    amoutLabel.backgroundColor=[UIColor clearColor];
//    amoutLabel.textAlignment=1;
//    amoutLabel.textColor=[UIColor whiteColor];
//    amoutLabel.font=[UIFont systemFontOfSize:10];
//    [amountImage addSubview:amoutLabel];
